...
const GroupPanel: React.FC<GroupPanelProps> = ({ namespace, groupType, groupItems, onClose, isOpen = true }) => {
      ...
      {isClosing ? (
        ...
        <>
          ...
          >
            ...
            <IconButton onClick={handleClose} sx={{ color: theme === "dark" ? "#D1D5DB" : "#6C757D" }}>
              <FiX />
            </IconButton>
          </Box>
          <Box sx={{ p: 2 }}>
