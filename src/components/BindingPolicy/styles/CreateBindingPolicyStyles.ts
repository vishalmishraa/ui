...
export const StyledTab = styled(Tab)(({ theme }) => ({
  ...
  '&:hover': {
    backgroundColor:
      theme.palette.mode === 'dark' ? 'rgba(255, 255, 255, 0.1)' : 'rgba(25, 118, 210, 0.04)',
    color: theme.palette.mode === 'dark' ? '#FFFFFF' : theme.palette.primary.main,
  },
...
export const StyledPaper = styled(Paper)(({ theme }) => ({
  ...
  transition: 'all 0.2s ease',
  backgroundColor:
    theme.palette.mode === 'dark' ? 'rgba(30, 41, 59, 0.7)' : theme.palette.background.paper,
...
export const getBaseStyles = (theme: string) => {
  ...
  return {
    ...
    helperTextColor: isDarkTheme ? 'rgba(255, 255, 255, 0.85)' : 'rgba(0, 0, 0, 0.6)',
  };
};
